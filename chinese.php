...
$_LANG['cartconfigdomainextras'] = "設定網域附加項目";
$_LANG['cartconfigoptionsdesc'] = "這各產品/服務有一些設定項目，您可以透過以下的選擇設定您的訂單。";
$_LANG['cartconfigserver'] = "設定伺服器";
$_LANG['cartcustomfieldsdesc'] = "本產品 / 服務需要您提供額外資訊以供我們處理您的訂單。";
$_LANG['cartdomainsconfig'] = "網域設定";
$_LANG['cartdomainsconfigdesc'] = "在以下的項目中，您可以透過購物車中設定網域名稱，並選擇所需的附加服務，為網域提供所需的資訊，並設定網域需要使用的名稱服務器(Nameserver)。";
...
$_LANG['carttaxupdateselections'] = "我們會根據您選擇的國家/地區收取稅款。 選擇後點擊按鈕將會重新計算金額。";
...
$_LANG['clientareaaccountaddons'] = "帳號附加功能";
$_LANG['clientareaactive'] = "可用";
$_LANG['clientareaaddfundsdisabled'] = "我們暫時不開發預儲功能。";
$_LANG['clientareaaddfundsnotallowed'] = "您需要有一筆有效的訂單才能存入預儲款，在有有效訂單之前，無法進行預儲！";
...
$_LANG['clientareacontactsemailssupport'] = "服務支援電子郵件-接收由帳戶持有人開啟的所有的Support Ticket 副本";
...
$_LANG['clientareaheader'] = "歡迎來到我們的會員專區，您可以在這裡管理您的帳戶。 此頁面簡要概述了在您的帳號之下，所有未解決的Ticket和尚未支付的帳單。請保持您正確的聯絡方式。";
...
$_LANG['clientareanavdetails'] = "詳細資訊";
...
$_LANG['clientareapendingregistration'] = "等待註冊中";
...
$_LANG['clientarearegistrationperiod'] = "註冊中";
...
$_LANG['clientregisterheadertext'] = "請輸入以下欄位以註冊新帳戶。";
$_LANG['clientregistertitle'] = "註冊";
$_LANG['clientregisterverify'] = "註冊驗證";
$_LANG['clientregisterverifydescription'] = "為防止自動註冊機器人，請輸入驗證碼。";
...
$_LANG['contacterrormessage'] = "有訊息還未輸入";
$_LANG['contacterrorname'] = "沒有輸入姓名";
$_LANG['contacterrorsubject'] = "您沒有輸入主旨";
$_LANG['contactheader'] = "購買前如果有任何疑問，歡迎隨時透過以下表單與我們聯繫";
$_LANG['contactmessage'] = "訊息";
$_LANG['contactname'] = "名稱";
$_LANG['contactsend'] = "傳送訊息";
$_LANG['contactsent'] = "您的訊息已經寄出";
$_LANG['contactsubject'] = "主旨";
$_LANG['contacttitle'] = "聯絡我們";
$_LANG['continueshopping'] = "繼續購物";
$_LANG['creditcard'] = "使用信用卡付款";
$_LANG['creditcard3dsecure'] = "為了預防欺詐，系統現在將進行Visa或Mastercard SecureCode驗證以完成付款。<br /> <br />請不要點瀏覽器的更新或回到上一頁的按鈕，否則驗證可能會被中斷 或取消。";
$_LANG['creditcardcardexpires'] = "有效期限";
$_LANG['creditcardcardissuenum'] = "編號";
...
$_LANG['creditcardconfirmation'] = "謝謝！ 您新的信用卡詳細資訊已通過驗證，並且已為您的帳戶支付了第一筆款項。 您將會收到有關此支付的確認電子郵件。";
$_LANG['creditcardcvvnumber'] = "CVV/CVC2 號碼";
$_LANG['creditcardcvvnumbershort'] = "CVV/CVC2";
$_LANG['creditcardcvvwhere'] = "我可以如何找到?";
$_LANG['creditcarddeclined'] = "您輸入的信用卡詳細資訊已被拒絕。 請嘗試使用其他卡或與發卡銀行服務人員聯繫。";
$_LANG['creditcarddetails'] = "信用卡資訊";
$_LANG['creditcardenterexpirydate'] = "您沒有輸入信用卡的有效期";
$_LANG['creditcardenternewcard'] = "您所輸入新的信用卡資訊如下";
$_LANG['creditcardenternumber'] = "您沒有輸入信用卡有持卡人姓名";
$_LANG['creditcardinvalid'] = "您輸入的信用卡詳細資訊無效。 請嘗試使用其他卡與發卡銀行服務人員聯繫。";
$_LANG['creditcardnumberinvalid'] = "您輸入的信用卡號碼無效";
$_LANG['creditcardsecuritynotice'] = "您在此處輸入的所有數據均會進行加密，以減少欺詐風險";
$_LANG['creditcarduseexisting'] = "使用現有的信用卡";
$_LANG['customfieldvalidationerror'] = "輸入的數值無效";
$_LANG['days'] = "天數";
$_LANG['hours'] = "小時數";
$_LANG['minutes'] = "分鐘數";
$_LANG['seconds'] = "秒數";
$_LANG['defaultbillingcontact'] = "預設帳務聯絡人";
$_LANG['domainalternatives'] = "嘗試以下替代方法：";
$_LANG['domainavailable'] = "可以使用! 請下單";
$_LANG['domainavailable1'] = "恭喜！";
$_LANG['domainavailable2'] = "可以使用!";
$_LANG['domainavailableexplanation'] = "如要註冊這個網域，請點擊下面的鏈接";
...
$_LANG['domaincurrentrenewaldate'] = "續訂日期";
$_LANG['domaindnsaddress'] = "地址";
$_LANG['domaindnshostname'] = "主機名稱";
$_LANG['domaindnsmanagement'] = "DNS管理";
$_LANG['domaindnsmanagementdesc'] = "通過設定IP位置將您的網域指向一個網站的IP，或轉發到另一個網站，或指向一個臨時的網頁。";
$_LANG['domaindnsrecordtype'] = "記錄類型";
$_LANG['domainemailforwarding'] = "Email 轉發";
$_LANG['domainemailforwardingdesc'] = "如果電子郵件轉發服務確定轉發地址無效，我們將自動禁用轉發。 請在再次啟用前檢查轉發的地址。 任何現有轉發記錄上的更改最多可能不會生效1個小時。";
$_LANG['domainemailforwardingforwardto'] = "轉發到";
$_LANG['domainemailforwardingprefix'] = "Prefix";
$_LANG['domaineppcode'] = "EPP 代碼";
$_LANG['domaineppcodedesc'] = "這需要從當前的註冊商處獲得授權";
$_LANG['domaineppcoderequired'] = "您必需輸入EPP代碼";
$_LANG['domainerror'] = "連接到網域註冊表時出現問題。 請稍後再試。";
$_LANG['domainerrornodomain'] = "請輸入有效的網域名稱";
$_LANG['domainerrortoolong'] = "您輸入的網域名稱太長。 最多只能有67個字元。";
$_LANG['domaingeteppcode'] = "取得 EPP 密碼";
$_LANG['domaingeteppcodeemailconfirmation'] = "EPP代碼申請成功！ 已發送到您註冊網域時的電子郵件地址。";
$_LANG['domaingeteppcodeexplanation'] = "EPP代碼是網域的密碼。 這是一種安全措施，可以確保網域的所有者才能做轉讓網域。 如果您想將網域域轉移到另一個註冊商，就會需要EPP代碼。";
$_LANG['domaingeteppcodefailure'] = "申請EPP代碼時有錯誤：";
$_LANG['domaingeteppcodeis'] = "您網域的EPP代碼是 :";
$_LANG['domainidprotection'] = "網域身份保護";
$_LANG['domainintrotext'] = "在下面的欄位輸入您要使用的網域，然後點“搜尋”，查看是否可以購買該網域。";
$_LANG['domainlookupbutton'] = "Lookup";
$_LANG['domainmanagementtools'] = "管理工具";
$_LANG['domainminyears'] = "短租期";
...
$_LANG['domainorderrenew'] = "續約訂單";
$_LANG['domainprice'] = "價格";
$_LANG['domainregisterns'] = "註冊 Nameservers";
$_LANG['domainregisternscurrentip'] = "目前您的 IP 位置";
$_LANG['domainregisternsdel'] = "刪除 Nameserver";
$_LANG['domainregisternsdelsuccess'] = "Nameserver 已成功刪除";
$_LANG['domainregisternsexplanation'] = "您可以在此處為您的網域新增和自訂 Nameserver（例如，NS1.example.com，NS2.example.com ...）。";
$_LANG['domainregisternsip'] = "IP 位置";
$_LANG['domainregisternsmod'] = "更改Nameserver IP";
$_LANG['domainregisternsmodsuccess'] = "Nameserver 修改成功";
$_LANG['domainregisternsnewip'] = "新IP 位置";
$_LANG['domainregisternsns'] = "名稱伺服器 (Nameserver)";
$_LANG['domainregisternsreg'] = "註冊 NameServer";
$_LANG['domainregisternsregsuccess'] = "Nameserver  註冊成功";
$_LANG['domainregistrantchoose'] = "選擇聯絡人";
$_LANG['domainregistrantinfo'] = "網域註冊資訊";
$_LANG['domainregistrarlock'] = "註冊鎖定";
$_LANG['domainregistrarlockdesc'] = "啟用註冊鎖定 (建議項目). 設置鎖定，可以防止未經授權的轉讓.";
$_LANG['domainregistration'] = "網域註冊";
$_LANG['domainregistryinfo'] = "網域註冊資訊";
...
$_LANG['domainsautorenewdisabledwarning'] = "警告！ 網域已經關閉自動續約。<br />因此，網域過期時將會自動轉成無效狀況並開放其他人註冊這個網域。";
...
$_LANG['domainreserved'] = "已預留";
$_LANG['domainreserved1'] = "網域";
$_LANG['domainreserved2'] = "可用，但保留。";
$_LANG['domainviewwhois'] = "查看 WHOIS 報告";
$_LANG['downloaddescription'] = "敘述";
$_LANG['downloadloginrequired'] = "拒絕訪問-您必需登入您的帳戶才能下載文件";
$_LANG['downloadname'] = "下載";
$_LANG['downloadpurchaserequired'] = "拒絕訪問-您必需先購買相關產品，然後才能下載產品";
$_LANG['downloadscategories'] = "分類";
$_LANG['downloadsdescription'] = "查看我們的下載庫";
...
$_LANG['flashtutorialsdescription'] = "單擊此處，向您展示如何使用主機控制面板的教學。";
$_LANG['flashtutorialsheadertext'] = "我們的Flash教程可幫助您充分利用網絡託管控制面板。 從下面選擇一個任務，以查看有關如何完成該主旨的階段教學。";
$_LANG['forwardingtogateway'] = "當您重新選擇另一個付款方式時，請等待...";
$_LANG['globalsystemname'] = "客戶系統";
$_LANG['globalyouarehere'] = "您在這裡";
$_LANG['go'] = "Go";
$_LANG['headertext'] = "歡迎來到技術支援中心！";
$_LANG['hometitle'] = "首頁";
$_LANG['imagecheck'] = "請輸入圖形驗證碼-這是防止Bot機械人的必要保護";
...
$_LANG['invoiceofflinepaid'] = "離線信用卡付款需要透過手動處理的。<br />付款完成後，您將通過電子郵件收到確認。";
$_LANG['invoicerefnum'] = "參考編號 ";
$_LANG['invoices'] = "我的帳單";
...
$_LANG['kbsuggestionsexplanation'] = "建議提交之前，可以先到知識庫中搜索文章，可能能夠解決您的疑問。";
$_LANG['knowledgebasearticles'] = "文章";
$_LANG['knowledgebasecategories'] = "分類";
$_LANG['nokbcategories'] = "沒有類別";
$_LANG['knowledgebasedescription'] = "瀏覽我們的知識庫以獲取常見問題解答的答案";
$_LANG['knowledgebasefavorites'] = "加入到我的最愛";
$_LANG['knowledgebasehelpful'] = "這篇文章有幫助嗎？";
$_LANG['knowledgebaseintrotext'] = "知識庫分為不同的類別。 從下面選擇類別，或者在知識庫中搜索問題的答案。";
...
$_LANG['knowledgebaseratingtext'] = "其他用戶推薦，很有幫助";
$_LANG['knowledgebaserelated'] = "相關文章";
$_LANG['knowledgebasesearch'] = "搜尋";
$_LANG['knowledgebasetitle'] = "知識庫";
$_LANG['knowledgebaseviews'] = "瀏覽數";
$_LANG['knowledgebasevote'] = "投票";
$_LANG['knowledgebasevotes'] = "投票數";
$_LANG['knowledgebaseyes'] = "是";
$_LANG['knowledgebaseArticleRatingThanks'] = "感謝您對文章的評分";
$_LANG['language'] = "語言";
$_LANG['latefee'] = "滯納金";
...
$_LANG['loginintrotext'] = "您必需登入以存取此頁面，此處登入所需的帳號與密碼可能與您的網站之控制面板不同。";
...
$_LANG['maxmind_callingnow'] = "系統正在自動撥打您的電話號碼。 這是我們驗證措施的一部分。 您會獲得一個4位數的安全碼，您需要在下面輸入這個安全碼以完成訂單。";
$_LANG['maxmind_countrymismatch'] = "您IP地址的國家/地區與您輸入的帳單地址國家/地區不匹配，請確認後再下訂單";
$_LANG['maxmind_error'] = "錯誤";
$_LANG['maxmind_faileddescription'] = "您輸入的安全碼不正確。 如果您確定輸入是正確的，請盡快與我們的客服部門聯繫。";
$_LANG['maxmind_highfraudriskscore'] = "您的訂單已被標記為高風險，因此已被保留進行人工審核。<br /> <br />可透過<a href=\"submitticket.php\">提交Ticket</a>給我們的客戶服務團隊。 謝謝。";
$_LANG['maxmind_highriskcountry'] = "很抱歉提醒您，由於您所在國家/地區涉有許多欺詐活動，因此我們無法接受您的訂單。 如果您想安排其他付款方式，請與我們聯繫。";
$_LANG['maxmind_incorrectcode'] = "密碼錯誤";
$_LANG['maxmind_pincode'] = "PIN 碼";
$_LANG['maxmind_rejectemail'] = "我們不允許使用免費的電子郵件地址進行申請，請使用其他電子郵件地址再試一次";
...
$_LANG['networkissuesdescription'] = "了解目前與計劃中的網絡維護";
...
$_LANG['nextpage'] = "下一頁";
$_LANG['no'] = "否";
$_LANG['nocarddetails'] = "沒有信用卡的詳細資訊記錄";
$_LANG['none'] = "無";
$_LANG['norecordsfound'] = "未找到任何紀錄";
$_LANG['or'] = "或";
$_LANG['orderadditionalrequiredinfo'] = "其他必需信息";
...
$_LANG['orderchangeaddons'] = "更改外掛";
$_LANG['orderchangeconfig'] = "更改可設定選項";
$_LANG['orderchangedomain'] = "變更網域";
$_LANG['orderchangenameservers'] = "只變更Nameserver";
$_LANG['orderchangeproduct'] = "變更產品";
$_LANG['ordercheckout'] = "結帳";
$_LANG['orderchooseaddons'] = "變更產品加值方案";
$_LANG['orderchooseapackage'] = "選擇方案";
$_LANG['ordercodenotfound'] = "您填寫的優惠碼並不存在。";
...
$_LANG['ordererroraccepttos'] = "您必需同意我們的服務條款";
$_LANG['ordererrordomainalreadyexists'] = "您填寫的網域已是經由我們註冊－在您建立新訂單前您需要將其取消。";
$_LANG['ordererrordomaininvalid'] = "您輸入的網域無效";
$_LANG['ordererrordomainnotld'] = "您必需輸入網域TLD";
$_LANG['ordererrordomainnotregistered'] = "您無法轉讓未註冊的網";
$_LANG['ordererrordomainregistered'] = "您輸入的域已註冊";
$_LANG['ordererrornameserver1'] = "您必需輸入 Nameserver 1";
$_LANG['ordererrornameserver2'] = "您必需輸入 Nameserver 2";
$_LANG['ordererrornodomain'] = "您沒有輸入網域";
$_LANG['ordererrorpassword'] = "您沒有輸入密碼";
$_LANG['ordererrorserverhostnameinuse'] = "您輸入的主機名稱已經存在。 請選擇另一個。";
$_LANG['ordererrorservernohostname'] = "您必需為您的主機輸入主機名稱";
$_LANG['ordererrorservernonameservers'] = "您必需為兩個Nameserver輸入一個prefix";
$_LANG['ordererrorservernorootpw'] = "您必需輸入root帳號的密碼";
$_LANG['ordererrorsubdomaintaken'] = "您輸入的子網域已被使用-請重試";
$_LANG['ordererrortransfersecret'] = "您必需輸入轉移密碼";
$_LANG['ordererroruserexists'] = "您輸入的電子郵件地址已申請過帳戶";
$_LANG['orderexistinguser'] = "我已經有會員帳號，希望將此訂單添加到我的帳戶中";
$_LANG['orderfailed'] = "訂購失敗";
$_LANG['orderfinalinstructions'] = "如果您對訂單有任何問題，請透過本客戶中心建立服務單，並附上您的訂單號碼，我們會在最短時間內協助您解決問題。";
$_LANG['orderfree'] = "免費！";
$_LANG['orderfreedomainappliesto'] = "僅適用於以下擴展";
$_LANG['orderfreedomaindescription'] = "根據選定的付款方式";
...
$_LANG['orderlogininfopart1'] = "請輸入登入帳號的密碼";
$_LANG['orderlogininfopart2'] = "會員專區。這與您網站控制面板的帳密與密碼不同。";
...
$_LANG['orderpaymentterm12month'] = "12個月價格";
$_LANG['orderpaymentterm1month'] = "1個月價格";
$_LANG['orderpaymentterm24month'] = "24個月價格";
$_LANG['orderpaymentterm3month'] = "3個月價格";
$_LANG['orderpaymentterm6month'] = "6個月價格";
...
$_LANG['orderpromoexpired'] = "您使用的優惠碼已經過期。";
$_LANG['orderpromoinvalid'] = "您輸入的優惠碼不適用於您目前選購的商品。";
$_LANG['orderpromomaxusesreached'] = "您輸入的優惠碼已被其他使用者使用。";
$_LANG['orderpromotioncode'] = "優惠碼";
$_LANG['orderpromovalidatebutton'] = "優惠碼確認";
$_LANG['orderPromoCodePlaceholder'] = "輸入您的優惠碼";
...
$_LANG['orderservernameserversdescription'] = "請輸入伺服器預設的Nameserver prefixes，例如。 ns1.example.com和ns2.example.com";
...
$_LANG['ordertaxstaterequired'] = "請輸入您所在地的州別";
$_LANG['ordertitle'] = "訂購";
$_LANG['ordertos'] = "服務條款";
$_LANG['ordertosagreement'] = "我已詳閱並同意";
$_LANG['ordertotalduetoday'] = "購物車金額合計";
$_LANG['ordertotalrecurring'] = "合計循環出帳金額";
$_LANG['ordertransferdomain'] = "移轉網域";
$_LANG['ordertransfersecret'] = "轉移密碼";
$_LANG['ordertransfersecretexplanation'] = "請輸入可以從當前域名註冊商處獲得的EPP代碼。 ";
...
$_LANG['registerdomaindesc'] = "在下面欄位輸入您要註冊的網域,檢查是否可申請。";
$_LANG['registerdomainname'] = "註冊一個網域名稱";
$_LANG['relatedservice'] = "與本問題相關的服務";
$_LANG['rssfeed'] = "Feed";
$_LANG['securityanswerrequired'] = "請輸入安全答案";
$_LANG['securitybothnotmatch'] = "您答錯囉!";
$_LANG['securitycurrentincorrect'] = "答錯囉!";
...
$_LANG['show'] = "顯示";
$_LANG['ssladmininfo'] = "管理人員聯絡方式";
$_LANG['ssladmininfodetails'] = "以下聯絡資訊不會顯示在憑證上-僅會用訂單資訊與您聯繫。 SSL憑證與未來服務將到期的提醒將發送到指定的電子郵件地址。";
$_LANG['sslcertapproveremail'] = "憑證核准電子郵件";
$_LANG['sslcertapproveremaildetails'] = "現在，您必須從下面的選項中進行選擇，您要在其中發送此證書的批准電子郵件請求。";
$_LANG['sslcertinfo'] = "SSL 憑證資訊";
$_LANG['pleasechooseone'] = "請選擇一項...";
$_LANG['sslcerttype'] = "證書類型";
$_LANG['sslconfigcomplete'] = "設定完畢";
$_LANG['sslconfigcompletedetails'] = "您必需完成項目選擇，並發送此證書的批准電子郵件請求...";
$_LANG['sslconfsslcertificate'] = "設定 SSL 證書";
$_LANG['sslcsr'] = "CSR";
$_LANG['sslerrorapproveremail'] = "您必需選擇一個核准人的電子郵件地址";
...
$_LANG['pwresetrequested'] = "密碼重設";
$_LANG['pwresetcheckemail'] = "請檢察您的信箱,收取重設確認郵件.";
...
$_LANG['subaccountpermsprofile'] = "修改主帳號資料";
...
$_LANG['vpsnetgenbackup'] = "執行備份";
$_LANG['vpsnetrestorebackup'] = "備份還原";
...
$_LANG['carterrordomainconfigskipped'] = "您必需返回並補上缺漏的網域設定才能繼續進行。";
...
$_LANG['orderpromopriceoverride'] = "優惠價";
...
$_LANG['promonewsignupsonly'] = "本優惠碼只適用於新客戶";
...
$_LANG['clientareacancelreasonrequired'] = "您必需提供申請撤銷之理由";
...
$_LANG['clientareanavsecurity'] = "帳戶安全設定";
$_LANG['twofactorauth'] = "雙重認證";
$_LANG['twofaenable'] = "開啟雙重認證";
$_LANG['twofadisable'] = "關閉雙重認證";
$_LANG['twofaenableclickhere'] = "點擊開啟";
$_LANG['twofadisableclickhere'] = "點擊關閉";
$_LANG['twofaenforced'] = "為了安全起見，我們建議您必開啟雙重認證，然後才能繼續。 該頁面將指導您完成設置過程。";

$_LANG['twofasetupgetstarted'] = "開始使用";
$_LANG['twofaactivationintro'] = "雙重認證為您的帳戶登入加強了額外的保護。一旦啟用並設定完成後，每次您登錄時，系統都會要求輸入帳號和密碼，以及雙重認證功能所產生的動態密碼。";
$_LANG['twofaactivationmultichoice'] = "請繼續，從下面選擇所需的雙重驗證方法。";
$_LANG['twofadisableintro'] = "如果要關閉雙重驗證，請在下面的字元中確認您的密碼.";
$_LANG['twofaactivationerror'] = "您的帳戶啟用“雙重驗證”時發生錯誤。 請再試一次.";
$_LANG['twofamoduleerror'] = "載入模組時發生錯誤。 請再試一次.";
$_LANG['twofadisableconfirmation'] = "您的帳號已關閉雙重驗證";
$_LANG['twofabackupcode'] = "備份碼";
$_LANG['twofabackupcodeintro'] = "如果您無法完成雙重驗證，就會需要用到備份碼才能登入您的帳戶。";
$_LANG['twofabackupcodeis'] = "您的備份碼是";
$_LANG['twofanewbackupcodeis'] = "您新的備份碼是";
$_LANG['twofabackupcodelogin'] = "輸入您的備份碼並登入";
$_LANG['twofabackupcodeexpl'] = " 將您的備份碼寫下並確保安全。<br />如果您丟失了雙重驗證的設備或設備損壞了，您將會需要用到備份碼。.";
$_LANG['twofaconfirmpw'] = "輸入您的密碼";
$_LANG['twofa2ndfactorreq'] = "輸入您的2FA雙重驗證碼.";
$_LANG['twofa2ndfactorincorrect'] = "您提供的雙重驗證碼錯誤。 請再試一次。 您還有：剩餘的可嘗試次數.";
$_LANG['twofabackupcodereset'] = "通過備份碼登錄成功<br />備份碼只能登入一次。 現在將重置備份碼.";
$_LANG['twofacantaccess2ndfactor'] = "遺失您的雙驗證裝置嗎?";
$_LANG['twofaloginusingbackupcode'] = "使用備份碼登入";
...
$_LANG['clientAreaSecurityTwoFactorAuthRecommendation'] = "我們強烈建議您啟用雙重驗證以提高帳戶安全性.";
...
$_LANG['orderForm']['correctErrors'] = "請修正以下的錯誤";
...
$_LANG['orderForm']['accountSecurity'] = "帳號安全";
$_LANG['orderForm']['mediumStrength'] = "Medium Strength";
$_LANG['orderForm']['paymentDetails'] = "付款明細";
$_LANG['orderForm']['preferredPaymentMethod'] = "請選擇付款方式.";
$_LANG['orderForm']['cardNumber'] = "Card Number";
$_LANG['orderForm']['cvv'] = "CVV Security Number";
$_LANG['orderForm']['additionalNotes'] = "備註";
...
$_LANG['orderForm']['configureDesiredOptions'] = "完成您的訂單後結帳.";
$_LANG['orderForm']['haveQuestionsContact'] = "有任何問題請洽線上客服";
$_LANG['orderForm']['haveQuestionsClickHere'] = "取得客服聯繫";
...
$_LANG['orderForm']['promotionAccepted'] = "已確認您的優惠碼！ 購物車的金額已更新。";
...
$_LANG['sso']['summary'] = "用第三方的系統執行“單一登入”的功能，來提供直接訪問您的帳戶的權限，不需要重新進行帳號驗證。";
$_LANG['sso']['disablenotice'] = "如果您不想開啟其他帳戶的訪問權限，可以禁用此功能。.";
$_LANG['sso']['enabled'] = "目前您的帳戶的單一登入狀態。";
$_LANG['sso']['disabled'] = "單一登入功能已經關閉.";
$_LANG['sso']['redirectafterlogin'] = "登入後跳轉";
...
$_LANG['orderForm']['transferToUs'] = "將您的網域轉入，享用特別優惠";
$_LANG['orderForm']['transferExtend'] = "轉入網域需要續約一年.";
...
$_LANG['remoteAuthn']['errorExclamation'] = "失敗!";
$_LANG['remoteAuthn']['error'] = "失敗";
$_LANG['remoteAuthn']['linkInitiated'] = "Link Initiated!";
$_LANG['remoteAuthn']['areYouSure'] = "請確認?";
$_LANG['remoteAuthn']['yesUnlinkIt'] = "已解除綁定!";
$_LANG['remoteAuthn']['unlinked'] = "解除綁定!";
...
$_LANG['remoteAuthn']['accountNowLinked'] = "您的帳號已綁定您的 :displayName 帳戶.";
...
$_LANG['remoteAuthn']['unlinkDesc'] = "這將取消帳戶綁定狀態。";
$_LANG['remoteAuthn']['mayHaveMultipleLinks'] = "將您的帳戶與以下服務綁定，可以方便您帳號登入。 ";
$_LANG['remoteAuthn']['titleSignUpVerb'] = "Sign Up";
$_LANG['remoteAuthn']['titleOr'] = "Or";
$_LANG['remoteAuthn']['titleLinkedAccounts'] = "帳號綁定";
$_LANG['remoteAuthn']['provider'] = "服務商";
$_LANG['remoteAuthn']['name'] = "名稱";
$_LANG['remoteAuthn']['emailAddress'] = "電子郵件信箱";
$_LANG['remoteAuthn']['actions'] = "狀態";
$_LANG['remoteAuthn']['noLinkedAccounts'] = "沒找到綁定的帳號";
$_LANG['remoteAuthn']['signInWith'] = "已登入 :provider";
$_LANG['remoteAuthn']['connectWith'] = "綁定 :provider";
$_LANG['remoteAuthn']['signUpWith'] = "已註冊 :provider";
...
$_LANG['emailMarketing']['joinOurMailingList'] = "訂閱電子報";
...
$_LANG['generatePassword']['btnLabel'] = "自動產生密碼";
$_LANG['generatePassword']['btnShort'] = "產生";
$_LANG['generatePassword']['title'] = "自動產生密碼";
$_LANG['generatePassword']['lengthValidationError'] = "密碼長度請保持8 ~ 64字元之間";
$_LANG['generatePassword']['pwLength'] = "密碼長度";
$_LANG['generatePassword']['generatedPw'] = "已產生密碼";
$_LANG['generatePassword']['generateNew'] = "產生新密碼";
$_LANG['generatePassword']['copyAndInsert'] = "複製後關閉";
...
$_LANG['twofanowenabled'] = "雙重驗證已經開啟";
$_LANG['twofacurrently'] = "目前已經是雙重驗證";
$_LANG['enabled'] = "開啟";
$_LANG['disabled'] = "關閉";
...
$_LANG['emailPreferences']['affiliate'] = "會員郵件 - 接收會員通知";
$_LANG['emailPreferences']['domain'] = "網域郵件 - 註冊/移轉確認 &amp; 續約通知";
$_LANG['emailPreferences']['general'] = "普通郵件 - 所有與帳戶相關的通知";
$_LANG['emailPreferences']['invoice'] = "收據郵件  - 收據支付、未支付 &amp; 過期通知";
$_LANG['emailPreferences']['product'] = "產品郵件 - 服務暫停或其他服務狀態通知";
$_LANG['emailPreferences']['support'] = "支援郵件 - 售前、售後支援通知";
...
$_LANG['navContacts'] = "聯絡人";
$_LANG['navUserManagement'] = "帳號管理";
$_LANG['navSwitchAccount'] = "帳號切換";
$_LANG['navAccountSecurity'] = "帳號安全";

$_LANG['never'] = "從不";

$_LANG['yourProfile'] = "個人資料";
...
$_LANG['userManagement']['title'] = "用戶管理";
$_LANG['userManagement']['managePermissions'] = "管理權限";
$_LANG['userManagement']['permissions'] = "權限";
$_LANG['userManagement']['usersFound'] = ":count 個使用者正在線上";
$_LANG['userManagement']['userDescriptor'] = "電子郵件信箱 / 最後登入時間";
$_LANG['userManagement']['lastLogin'] = "最後登入時間";
$_LANG['userManagement']['actions'] = "活動狀";
$_LANG['userManagement']['emailAddress'] = "電子郵件";
$_LANG['userManagement']['removeAccess'] = "踢除連線";
$_LANG['userManagement']['pendingInvites'] = "Pending Invites";
$_LANG['userManagement']['inviteSent'] = "Invite Sent";
$_LANG['userManagement']['resendInvite'] = "重送邀請";
$_LANG['userManagement']['cancelInvite'] = "終止邀請";
$_LANG['userManagement']['accountOwnerPermissionsInfo'] = "帳號擁有者對客戶帳戶具有完全權限。";
$_LANG['userManagement']['inviteNewUser'] = "邀請新用戶";
$_LANG['userManagement']['inviteEmail'] = "用戶信箱";
$_LANG['userManagement']['inviteNewUserDescription'] = "可以邀請新用戶加入您的帳號。如果被邀請者已經有一個現成的帳號的話，他們將可以使用自有的帳號做訪問。 如果這位用戶還沒有帳號，就可以註冊一個新的帳號使用。";
$_LANG['userManagement']['allPermissions'] = "所有權限";
$_LANG['userManagement']['choosePermissions'] = "選擇權限";
$_LANG['userManagement']['sendInvite'] = "發出邀請";
...
$_LANG['userManagement']['settings'] = "以下安全設置將套用到您的帳戶中。";

$_LANG['userProfile']['profile'] = "基本資料";
$_LANG['userProfile']['changeEmail'] = "更改電子郵件信箱";
$_LANG['userProfile']['notVerified'] = "郵件信箱還未驗證";
$_LANG['userProfile']['verified'] = "郵件信箱已驗證";
